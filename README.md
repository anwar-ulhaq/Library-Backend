# Library Backend created from TypeScript MEN (MongoDB, ExpressJS, NodeJS) boilerplate
This project is based on the [TypeScript Node Starter](https://github.com/microsoft/TypeScript-Node-Starter) whose documentation is below, with some modifications
...
This preprocesses step is very flexible, but in our case, we just want to compile our TypeScript to JavaScript using our `tsconfig.json`.
